    ...
    def decorator(sample_analysis):
        def wrapper(data, operation):
            ...
            if operation == 'int_sum':
                return total_sum_int  
            elif operation == 'float_sum':
                return total_sum_float   
...
if __name__ == '__main__':
    ...
    for i in range(N):
        ...
        total_sum = ClassTest.sample_analysis(result_data, 'int_sum') 
        print("Total Sum of 'int' Values in Random Data:",total_sum)

        average = ClassTest.sample_analysis(result_data, 'int_average')  
        print("Average of 'int' Values in Random Data:",average)

        total_sum = ClassTest.sample_analysis(result_data, 'float_sum')  
        print("Total Sum of 'float' Values in Random Data:", total_sum)

        average = ClassTest.sample_analysis(result_data, 'float_average')  
