...
def Randomdata_diedai(count, **kwargs):
    for _ in range(count):
        yield generate_structure(**kwargs)


@datastructure_calculator('both')
def main(n, calc_type, data_generator, **kwargs):
    return data_generator(n, **kwargs)
...
if __name__ == "__main__":
    ...
    data_generator = Randomdata_diedai(n, **data_structure)
    for generated_data in main(n, calc_type, **data_structure):
