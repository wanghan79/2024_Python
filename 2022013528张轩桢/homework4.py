...
class RandomDataStructure:
    ...
    def randomdata_diedai(self, count, **kwargs):
        for _ in range(count):
            yield self.generate_structure(**kwargs)

    def main(self, n, calc_type, **kwargs):
        return self.datastructure_calculator(calc_type)(self.randomdata_diedai)(n, **kwargs)
...
if __name__ == "__main__":
    ...
    rds = RandomDataStructure()
    for generated_data in rds.main(n, calc_type, **data_structure):
