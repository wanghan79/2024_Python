...
class RandomDataGenerator:
    ...
    def collect_numbers(self, data, **kwargs):
        ...
        if isinstance(data, int):
            ...
            for item in data:
                int_sum, int_count, float_sum, float_count = self.collect_numbers(item, int_sum=int_sum,
                                                                                  int_count=int_count,
                                                                                  float_sum=float_sum,
    ...
    def main(self):
        ...
        for i in range(n):
            ...
            random_data = self.generate_structure(**data_structure)

            all_int_sum, all_int_count, all_float_sum, all_float_count = self.collect_numbers(random_data,
                                                                                              int_sum=all_int_sum,
