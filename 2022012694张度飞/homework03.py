...
def decorator(aclass):
    ...
    class Decorator():
        def __init__(self, data_structure):
            self.aclass_instance = aclass(data_structure)

        def gen_random_data(self, data_structure):
            self.aclass_instance.gen_random_data(data_structure)

        def gen_multi_random_data(self, num):
            data = self.aclass_instance.gen_multi_random_data(num)
