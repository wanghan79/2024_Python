...
class DataSampler:
    ...
    def generate_data(self, data_structure, count):
        for _ in range(count):
            yield self.data_Sampling(**data_structure)
...
def main(n, calc_type, **kwargs):
    sampler = DataSampler()
    return sampler.generate_data(data_structure, n)
...
if __name__ == "__main__":
    ...
    for data in main(n, calc_type, data_structure=data_structure):  # 使用关键字参数传递 data_structure
        print(data)